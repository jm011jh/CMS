...
export default function AdminMainSnsList() {
    ...
    const callListBySearch = async () => {
        ...
        const url = `/api/admin/mgmt/sns${query}`;
                    ...
                    <div className="adm--box-scrollCont">
                        ...
                        <div className="adm--pg-act">
                            ...
                            <div className="adm--pg-act-btn">
                                <button className="btn purple medium radius" onClick={(e) => router.push("/admin/pages/main/snslist/view")}>SNS 등록</button>
                            </div>
                        </div>
                                    ...
                                    bdList.map((item: any) =>
                                        <div className="admin--cl-tr" key={item.index}>
                                            ...
                                            <div className="admin--cl-td action">
                                                <div onClick={() => router.push(`/admin/pages/main/snslist/view?id=${item.index}`)} className="btn primary xsmall radius">수정</div>
