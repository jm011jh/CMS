...
const AdmSubsUserPopup: React.FC<AdmSubsUserPopupProps> = ({ data, status, close, statusChange }) => {
    ...
    const tableStructureData: AdmListTableCellProps[] = [
        ...
        { id: '', value: '구독 상품명', size: '240px', cellKey: 'currentStatus' },
        { id: '', value: '주문 ID', size: '100%', cellKey: 'originalTransactionId' },
        ...
        <div style={styles.container} >
                                ...
                                </div>
                                {
                                    detailData && detailData.subscriptions && detailData.subscriptions.map((period: any, index: number) => (
                                        <div key={index} style={{
                                            ...
                                            <div style={{ ...styles.bodyBoxScrollTableValue, width: '240px', minWidth: '240px', borderLeft: `1px solid ${basicThemeColors.gray300}` }}>{period.plan?.name}</div>
                                            <div style={{ ...styles.bodyBoxScrollTableValue, width: '100%', minWidth: 'auto', borderLeft: `1px solid ${basicThemeColors.gray300}` }}>{period.originalTransactionId}</div>
            ...
            }
            {
                ...
                <div style={styles.wrapper}>
                    ...
                    <AdmDataErrorTable text1="구독 내역이 없습니다." text2="잠시 후 다시 시도해주세요." />
                </div>
            }
        </div >
    )
