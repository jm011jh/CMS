...
const API_URL_LIST = '/api/admin/font-subscription'; // Define the API URL for listing
const API_URL_GETLIST = '/admin/subs/font_user'; // Define the API URL for getting the list
const URL_LIST = '/admin/subs/font_user'; // Define the URL for listing in the admin board
const URL_VIEW = '/admin/subs/font_user/view?id='; // Define the API URL for editing
    ...
    const callListBySearch = async () => {
        ...
        try {
            ...
            const tableStructureData: AdmListTableCellProps[] = [
                { id: '', value: '닉네임', size: '198px', cellKey: 'name' },
                ...
                { id: '', value: '구독 상품명', size: '180px', cellKey: 'productName' },
